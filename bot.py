...
PLANS = {
    "plan_300": {
        ...
        "invites": 1,
        "title": "🌟 VIP – 300 звёзд",
        "description": "Максимум эмоций: фото/видео самолёт!",
        "payload": "plan_300"
    },
    "plan_500": {
        "stars": 500,
        ...
        "description": "Лучший подарок – видеопоздравление!",
        "payload": "plan_500"
    },
    "plan_1000": {
        "stars": 1000,
        ...
        "description": "Твоя встреча с кумиром в прямом эфире!",
        "payload": "plan_1000"
    }
}
...
class BotHandlers:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text = (
            ...
            "📢 Собираем Книгу Рекордов Гиннесса:\n"
            "✨ Пожелание на самолёте Роналду!\n\n"
            "👇 Выбери свой тариф:"
        )
